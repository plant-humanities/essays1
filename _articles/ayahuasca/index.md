...
`map #map2 basemap=Esri_WorldPhysical center=-20.2555,-60.05974 zoom=2.8 caption="Map of South America showing Indigenous territories (green), Bolivia (purple), and Cueva del Chileno (photo). GeoJSON files courtesy of Native Land Digital, 2015, CC0. https://native-land.ca/"`
`- geojson active url=South_America_Native_Lands.json layer="Indigenous territories (green)." show-labels`
...
`image src=Bundles_of_ayahuasca.jpg aspect=1.50`
`image src=Decorated_ritual_ceramic_vase.jpg aspect=0.67`
`image src=Pottery_cup_with_raised_base.jpg aspect=1.75`
...
`image src=7463889.jpg region=pct:7.99,18.44,80.15,51.21 aspect=0.63 cover`
...
`image src=wc:2005_Comparing_Traditional_Ecological_Knowledge_(TEK)_to_Western_Science_-_Fish_&_Wildlife_Service_chart_circa_2014.svg aspect=1.46 .large`
...
<!-- Broken images
`image src=bf59b0f6caeb2fb92bfba25e4b08012203ad6a4f7b1d971aa9c4d8feb7b71d1a.yaml`
`image src=0b4d2805ee6de36911fb255f51988b716418e4edf59c055d56569a7847571b7f.yaml`
-->
...
`image src=47391371.jpg aspect=0.60`
