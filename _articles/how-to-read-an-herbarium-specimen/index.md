...
description: This richly illustrated article by Maura Flannery explores how herbarium specimens—pressed, preserved plants—serve as vital scientific and historical documents. It traces their evolution from 16th-century collections to modern tools for tracking biodiversity and climate change. Through case studies like Darlingtonia californica and the Lewis and Clark expedition, the piece reveals how specimens preserve botanical knowledge, collector histories, and even indigenous expertise.
...
`header title="How to Read an Herbarium Specimen" author="Maura Flannery" img=Rauwolf.jpg` 
...
`image src=Long-Leafed_Sage.jpg caption="Long-Leafed Sage" aspect=0.67`
...
`image src=Parica.jpg aspect=0.59`
