...
`header title="Contrayerva" author="Ashley Buchanan" img=Contrayerva_Header.jpg` 
...
`map center=4.98477,-182.98311 zoom=0.5`
`- geojson layer="Drake's circumnavigation between 1577 and 1580." url=drake.json`

##
{: .wrap}

As long-distance seaborn trade and European colonialism grew over the course of the early modern period, explorers like Drake as well as merchants, diplomats, privateers, and travelers became essential in the collection and dissemination of local or indigenous plant knowledge and specimens to European naturalists, physicians, and apothecaries. Which is why, in 1581, famed naturalist Charles Ècluse (often referred to as Clusius) travelled to [London](img1/zoomto/3041,1428,736,626) to meet Drake and his men, hear their stories, and learn about what new plants they had encountered. 

`image #img1 region=944,1013,3162,2688 src=Drake.jpg aspect=1.25`
...
`image src=bhl-58480828.jpg aspect=0.66`
`image src=bhl-58480797.jpg aspect=0.70`
...
`image src=bhl-58480796.jpg aspect=0.66`
...
`image src=58VbAAAAQAAJ_PA28.jpg caption="Page from Simplicium medicamentorum ex novo orbe delatorum, quorum in medicina usus est, historia Hispan. sermone descripta" source=https://books.google.com/books/content?id=58VbAAAAQAAJ&hl=it&pg=PA28&img=1&zoom=3&bul=1&sig=ACfU3U301EvEkTa9RXDbUJhUZuMqsAvQbQ&w=1025 aspect=0.65`
`image src=bhl-58480797.jpg aspect=0.70`
...
`map center=-9.130550123807534,-70.78263840714388 zoom=3.5`
`- geojson layer="Map of Latin America displaying the approximate regional footprint of indigenous populations prior to Spanish conquests." url=pre_conquest.json`
...
<!-- Broken image
`image src=https://content.wdl.org/10096/service/thumbnail/1431369762/1024x1024/3/602.jpg aspect=`
-->
...
`iframe src=https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html source=18EgV6ZTmJmPWsCk7zXklA4O8GlK9uCO4TTjg5NZkVPo timenav-position=bottom hash-bookmark=false initial-zoom=1 height=750`
...
`image-compare before=Compare_B.jpg after=Compare_FC.jpg aspect=`
...
`image src=Florentine_Codex_Open.jpg aspect=1.56`
...
`image src=FC_Coanenepilli.jpg aspect=1.50`
...
`image src=bhl-55231362.jpg region=1,166,2566,2192 aspect=0.74`
`image src=bhl-42728883.jpg aspect=0.74`
...
`image src=10.5555_al.ap.specimen.br0000013080891.jpg aspect=0.60`
`image src=10.5555_al.ap.specimen.p00307405.jpg aspect=0.63`
`image src=10.5555_al.ap.specimen.e00413821.jpg aspect=0.61`
...
`image src=bhl-40358907.jpg aspect=0.57`
`image src=bhl-40289149.jpg aspect=0.57`
...
`map center=19.435,-99.131389 zoom=5`
`- geojson url=Nahua.json`
...
`image src=Contrayerva_specimen.jpg aspect=0.69`
...
`image src=4241393.jpg source=https://digital.ub.uni-duesseldorf.de/download/webcache/2000/4241393 aspect=0.82`
...
`image src=Fever_water.jpg aspect=1.24`
...
`image src=bhl-673094.jpg aspect=0.71`
...
`image src=wc:Dorstenia_contrajerva.jpg region=0,2190,4012,3474 aspect=0.63`
