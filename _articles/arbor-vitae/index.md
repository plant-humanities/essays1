...
`image src=56601375.jpg aspect=0.73 .small`
...
`image src=wc:La_Terra_De_Hochelaga_Nella_Nova_Francia%2C_Contributed_by_McGill_University_Library.jpg caption="La Terra De Hochelaga Nella Nova Francia, plan dessiné par Giacomo Gastaldi, paru dans le livre en italien de Giovanni Battista Ramusio, Delle Navigationi et Viaggi, volume III (Venise, 1565)." aspect=1.38`
...
`image src=nebc00056528.jpg aspect=0.69`
`image src=a00022322.jpg aspect=0.69`
`image src=a00022346.jpg aspect=0.70`
`image src=l0820001.jpg aspect=0.58`
`image src=linn-hl1136-1.jpg aspect=0.81`
...
`image src="wc:A_case_of_Scurvy_journal_of_Henry_Walsh_Mahon.jpg aspect=0.63`
...
`image src=Vitamin_C_in_conifers.jpg aspect=1.01`
...
`map center=48.402,2.700 zoom=10 caption="France" aspect=1`
`image src=wc:Fontainebleau_bird%27s_eye_view.jpg aspect=0.74`
...
`image src=56601375.jpg aspect=0.73`
`image src=529649.jpg aspect=0.61`
`image src=49828508.jpg aspect=0.68`
`image src=359023.jpg aspect=0.60`
...
`map center=Q48335 zoom=5 caption="Newfoundland" basemaps=Esri_WorldPhysical`
