...
date: 2025-01-01
layout: post
thumbnail: "wc:Indigofera_heterantha_Indygowiec_2019-07-20_03.jpg"
permalink: /indigo
...
`image src=wc:Indus_Valley_Civilization,_Mature_Phase_(2600-1900_BCE).png aspect=1.23`
...
`image src=wc:Caricature_gillray_plumpudding.jpg aspect=1.4`
...
`map center=17.620068,-71.562101 zoom=5`
`- marker label="Indigo production in Haiti" url=https://si.regeneratedidentities.org/project/DataFiles/SI-OB-388/388-4.jpg coords="19.057147, -72.527066" circle=true layer="Haiti"`
...
`image src=388-4.jpg caption="Indigo Production, French West Indies, 1667" description="from Histoire Générale des Antilles Habitées par les Francois (1667–1671)." license="Public domain" source=https://si.regeneratedidentities.org/project/DataFiles/SI-OB-388/388-4.jpg aspect=1.57`
...
`image src=artdelindigotie00Beau_0135.jpg aspect=0.57 .small`
...
`image src=wc:Main_House,_Snee_Farm,_Mount_Pleasant,_SC_-_50738315566.jpg aspect=1.33`
...
`map center=32.818369,-79.929117 zoom=11 caption="Charleston, South Carolina"`
`- geojson url=SCgeo.json layer="South Carolina"`
`- marker label="Charles Pinckney National Historic Site" coords="32.846074, -79.824693" url=wc:Charles_Pinckney_National_Historic_Site_%28de0d374d-090d-46eb-b83a-a106effa97c4%29.jpg circle=true layer="Charles Pinckney National Historic Site"`
...
`image src=wc:20-Group-of_Indigo-beaters.jpg aspect=1.25`
...
`image src=54027-h.jpg license="Public Domain" caption="Nil Darpan; or, the Indigo Planting Mirror" description="Front page of Nil Darpan, 1861 English translation" source=https://www.gutenberg.org/files/54027/54027-h/images/cover.jpg aspect=0.58 .small`
...
`iframe src=https://books.google.com/books?id=q5ZeAAAAcAAJ&pg=PP5&output=embed aspect=0.62`
...
`image src=wc:Indigo_factory_bengal2_(1).jpg aspect=1.35`
...
`image src=wc:Stamp_of_India_-_2017_-_Colnect_700591_-_Centenary_of_the_Champaran_Indigo_Farmers_Satyagraha.jpeg aspect=1.33`
...
`image src=wc:Clipping_of_Denim_Pant.JPG aspect=`
...
`image src=wc:Pamela_Ferrell_on_set_Film_Daughters_of_the_Dust_in_1989.png aspect=0.98`
...
`image src=wc:Zeugfärberei_Gutau_Blaufärbung_von_Textilien.jpg aspect=1.52`
...
`image src=04336021.jpg caption="NYBG Indigo Specimen" description="From the African American Garden." license="Public domain" source=https://sweetgum.nybg.org/images3/4088/968/04336021.jpg aspect=0.68`
...
`image src=wc:Tissages_de_coton_indigo_01.jpg aspect=1.50`
...
`image src=wc:Indigo-guizhou.jpg aspect=1.33`
