...
`image #bananas src=Banana_Plant_Parts.jpg aspect=1.02`
...
`image src=c25fa141a470ac070cc8bc6243c447f91f12c2711a843ac3d571c0159ef513c9.yaml aspect=`
 -->
...
`map caption="Early Modern Names for Banana" center=7.71371,12.65625 zoom=1 basemap=Esri_WorldPhysical`
...
<!-- Image no longer available - https://promusa.orgpreview3344/
`image region=-7,1,674,519 src=f3470082f04ed996a163ba4c60f1f67d87ca3145f154ea9dc0cbfa7a17006db4.yaml aspect=`
-->
...
`map caption="Top 20 Banana Producing Countries 2012" center=13.91608,14.0625 zoom=1`
